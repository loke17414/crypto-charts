...
const PanelGuides = (() => {
  const GUIDES = {
    ...
    account: {
      title: '계정',
      body: [
        'Orbinex 로그인 계정입니다. 봇·GPT·결제·저장된 API 키는 이 계정에 묶입니다.',
        '회원가입 후 이메일 인증이 필요합니다. 메일이 안 오면 스팸함을 확인하세요.',
        'Free는 주간 봇 시간·GPT 횟수·전략 슬롯이 제한됩니다. Pro는 봇 무제한·GPT 주 100회·멀티슬롯·추천 전략이 가능합니다.',
    ...
    strategyLog: {
      ...
      body: [
        ...
        '이 내용은 GPT 전략 대화에도 함께 전달되어, AI가 현재 차트를 참고하게 합니다.',
