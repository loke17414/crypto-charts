  ...
  const GUIDES = {
    bot: {
      ...
      body: [
        ...
        '상단에서 BTC·ETH 등 거래 심볼을 선택할 수 있습니다. 봇 실행 중에는 심볼을 바꿀 수 없습니다.',
        '봇 진입 분봉은 신호를 볼 봉 주기입니다. 차트와 다르게 두면 시작 시 차트가 그 봉으로 맞춰질 수 있습니다.',
        '자동 정지(Pro): N회 거래(청산) 후, N시간 후, N분 후 중 하나를 고르면 조건 충족 시 봇이 멈춥니다.',
    ...
    account: {
      ...
      body: [
        ...
        'Free는 주간 봇 시간·AI 횟수·전략 슬롯이 제한됩니다. Pro는 봇 무제한·AI 주 50회·멀티슬롯·추천 전략이 가능합니다.',
